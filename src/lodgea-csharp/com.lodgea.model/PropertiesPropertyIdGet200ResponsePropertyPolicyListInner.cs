...
namespace lodgea-csharp.com.lodgea.model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PropertiesPropertyIdGet200ResponsePropertyPolicyListInner :  IEquatable<PropertiesPropertyIdGet200ResponsePropertyPolicyListInner>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesPropertyIdGet200ResponsePropertyPolicyListInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PropertiesPropertyIdGet200ResponsePropertyPolicyListInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesPropertyIdGet200ResponsePropertyPolicyListInner" /> class.
        /// </summary>
        ...
        public PropertiesPropertyIdGet200ResponsePropertyPolicyListInner(decimal checkInTime = default(decimal), decimal checkOutTime = default(decimal), decimal totalGuestCount = default(decimal), List<PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner> cancellationPolicyList = default(List<PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner>), decimal advanceBookingMin = default(decimal), decimal advanceBookingMax = default(decimal), PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerPetsPolicy petsPolicy = default(PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerPetsPolicy), PrepaymentPolicyEnum? prepaymentPolicy = default(PrepaymentPolicyEnum?), PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerGuaranteePolicy guaranteePolicy = default(PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerGuaranteePolicy), List<PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner> taxPolicyList = default(List<PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner>), List<PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerFeePolicyListInner> feePolicyList = default(List<PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerFeePolicyListInner>), string name = default(string))
        {
            ...
            {
                throw new InvalidDataException("checkOutTime is a required property for PropertiesPropertyIdGet200ResponsePropertyPolicyListInner and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("cancellationPolicyList is a required property for PropertiesPropertyIdGet200ResponsePropertyPolicyListInner and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("advanceBookingMin is a required property for PropertiesPropertyIdGet200ResponsePropertyPolicyListInner and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("advanceBookingMax is a required property for PropertiesPropertyIdGet200ResponsePropertyPolicyListInner and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("taxPolicyList is a required property for PropertiesPropertyIdGet200ResponsePropertyPolicyListInner and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("feePolicyList is a required property for PropertiesPropertyIdGet200ResponsePropertyPolicyListInner and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertiesPropertyIdGet200ResponsePropertyPolicyListInner {\n");
        ...
        {
            return this.Equals(input as PropertiesPropertyIdGet200ResponsePropertyPolicyListInner);
        }

        /// <summary>
        /// Returns true if PropertiesPropertyIdGet200ResponsePropertyPolicyListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesPropertyIdGet200ResponsePropertyPolicyListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesPropertyIdGet200ResponsePropertyPolicyListInner input)
        {
            if (input == null)
                return false;
