...
namespace lodgea-csharp.com.lodgea.model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1PropertyGetPost200ResponsePropertyGeoEn :  IEquatable<V1PropertyGetPost200ResponsePropertyGeoEn>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1PropertyGetPost200ResponsePropertyGeoEn" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as V1PropertyGetPost200ResponsePropertyGeoEn);
        }

        /// <summary>
        /// Returns true if V1PropertyGetPost200ResponsePropertyGeoEn instances are equal
        /// </summary>
        /// <param name="input">Instance of V1PropertyGetPost200ResponsePropertyGeoEn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1PropertyGetPost200ResponsePropertyGeoEn input)
        {
            if (input == null)
                return false;
