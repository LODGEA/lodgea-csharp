...
namespace lodgea-csharp.com.lodgea.model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner :  IEquatable<PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner" /> class.
        /// </summary>
        ...
        public PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner(decimal percentAfterReservation = default(decimal), decimal nightsAfterReservation = default(decimal), decimal deadlineDays = default(decimal), decimal deadlineHours = default(decimal), decimal percentAfterDeadline = default(decimal), decimal nightsAfterDeadline = default(decimal), string noShowPolicy = default(string))
        {
            ...
            {
                throw new InvalidDataException("percentAfterReservation is a required property for PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("nightsAfterReservation is a required property for PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("deadlineDays is a required property for PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("deadlineHours is a required property for PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("percentAfterDeadline is a required property for PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("nightsAfterDeadline is a required property for PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("noShowPolicy is a required property for PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner);
        }

        /// <summary>
        /// Returns true if PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerCancellationPolicyListInner input)
        {
            if (input == null)
                return false;
