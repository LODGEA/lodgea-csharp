...
namespace lodgea-csharp.com.lodgea.model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1PropertyGetPost200ResponsePropertyGeoDe :  IEquatable<V1PropertyGetPost200ResponsePropertyGeoDe>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1PropertyGetPost200ResponsePropertyGeoDe" /> class.
        /// </summary>
        ...
        public V1PropertyGetPost200ResponsePropertyGeoDe(V1PropertyGetPost200ResponsePropertyGeoDeLocation location = default(V1PropertyGetPost200ResponsePropertyGeoDeLocation), string formattedAddress = default(string), string placeId = default(string), string locality = default(string), string administrativeAreaLevel3 = default(string), string administrativeAreaLevel1 = default(string), string stateCode = default(string), string country = default(string), string countryCode = default(string), string postalCode = default(string), string language = default(string), string naturalFeature = default(string), string establishment = default(string), string sublocality = default(string), string sublocalityLevel1 = default(string), string streetNumber = default(string), string route = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V1PropertyGetPost200ResponsePropertyGeoDe {\n");
        ...
        {
            return this.Equals(input as V1PropertyGetPost200ResponsePropertyGeoDe);
        }

        /// <summary>
        /// Returns true if V1PropertyGetPost200ResponsePropertyGeoDe instances are equal
        /// </summary>
        /// <param name="input">Instance of V1PropertyGetPost200ResponsePropertyGeoDe to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1PropertyGetPost200ResponsePropertyGeoDe input)
        {
            if (input == null)
                return false;
