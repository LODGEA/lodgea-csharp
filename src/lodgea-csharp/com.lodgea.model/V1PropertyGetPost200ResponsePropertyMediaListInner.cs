...
namespace lodgea-csharp.com.lodgea.model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1PropertyGetPost200ResponsePropertyMediaListInner :  IEquatable<V1PropertyGetPost200ResponsePropertyMediaListInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1PropertyGetPost200ResponsePropertyMediaListInner" /> class.
        /// </summary>
        ...
        public V1PropertyGetPost200ResponsePropertyMediaListInner(bool isMainImage = default(bool), decimal sortOrder = default(decimal), string url = default(string), List<V1PropertyGetPost200ResponsePropertyMediaListInnerTagListInner> tagList = default(List<V1PropertyGetPost200ResponsePropertyMediaListInnerTagListInner>), List<string> moderationLabelList = default(List<string>), List<string> detectionLabelList = default(List<string>), List<string> propertyAmenityList = default(List<string>), List<string> roomAmenityList = default(List<string>))
        {
        ...
        public List<V1PropertyGetPost200ResponsePropertyMediaListInnerTagListInner> TagList { get; set; }
        ...
        public List<string> RoomAmenityList { get; set; }
        ...
        {
            return this.Equals(input as V1PropertyGetPost200ResponsePropertyMediaListInner);
        }

        /// <summary>
        /// Returns true if V1PropertyGetPost200ResponsePropertyMediaListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of V1PropertyGetPost200ResponsePropertyMediaListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1PropertyGetPost200ResponsePropertyMediaListInner input)
        {
            if (input == null)
                return false;
