...
namespace lodgea-csharp.com.lodgea.model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AvailabilitySearchPostRequest :  IEquatable<AvailabilitySearchPostRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The unit system to use in the result.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>Defines the type of&lt;code&gt;locationName&lt;/code&gt;. If &lt;code&gt;locationType&lt;/code&gt; is set, &lt;code&gt;locationName&lt;/code&gt; has to bet set as well.&lt;p&gt;See also &lt;a href&#x3D;\&quot;#locationtypes\&quot;&gt;in the appendix&lt;/a&gt;.&lt;/p&gt;</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>The criteria to order the results by. Sort order for price is ascending, sort order for quality is always descending. Quality is an internally calculated score for the property.&#39;,           )}</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AvailabilitySearchPostRequest" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="AvailabilitySearchPostRequest" /> class.
        /// </summary>
        /// <param name="adultCount">The amount of adults that will stay at the property. (default to 2).</param>
        /// <param name="childCount">The amount of children that will stay at the property..</param>
        /// <param name="childAgeList">A list describing the ages of the children that will stay at the property. If &lt;code&gt;childAgeList&lt;/code&gt; is set &lt;code&gt;childCount&lt;/code&gt; has to be set as well. If &lt;code&gt;childAgeList&lt;/code&gt; and &lt;code&gt;childCount&lt;/code&gt; are set, &lt;code&gt;childCount&lt;/code&gt; must be equal to the length of &lt;code&gt;childAgeList&lt;/code&gt;..</param>
        ...
        /// <param name="unitSystem">The unit system to use in the result. (default to UnitSystemEnum.Metric).</param>
        /// <param name="minLengthOfStay">The desired minimum length of stay in nights..</param>
        /// <param name="maxLengthOfStay">The desired maximum length of stay in nights..</param>
        /// <param name="locationName">The name of a location the properties should be located in.If &lt;code&gt;locationType&lt;/code&gt; is set, &lt;code&gt;locationName&lt;/code&gt; has to bet set as well..</param>
        /// <param name="locationType">Defines the type of&lt;code&gt;locationName&lt;/code&gt;. If &lt;code&gt;locationType&lt;/code&gt; is set, &lt;code&gt;locationName&lt;/code&gt; has to bet set as well.&lt;p&gt;See also &lt;a href&#x3D;\&quot;#locationtypes\&quot;&gt;in the appendix&lt;/a&gt;.&lt;/p&gt;.</param>
        /// <param name="earliestArrival">The earliest possible arrival date. Expects exactly the format of \&quot;YYYY-MM-DD\&quot;..</param>
        /// <param name="latestReturn">The latest possible departure date. Expects exactly the format of \&quot;YYYY-MM-DD\&quot;..</param>
        /// <param name="sort">The criteria to order the results by. Sort order for price is ascending, sort order for quality is always descending. Quality is an internally calculated score for the property.&#39;,           )}.</param>
        /// <param name="serviceList">A list of service codes indicating which services and amenities the entire property should offer. The codes are AND chained.&lt;p&gt;See also &lt;a href&#x3D;\&quot;#servicecodes\&quot;&gt;in the appendix&lt;/a&gt;.&lt;/p&gt;.</param>
        /// <param name="typeList">A list of property class type codes specifying the desired property classes. The codes are OR chained.&lt;p&gt;See also &lt;a href&#x3D;\&quot;#propertyclass-type-codes\&quot;&gt;in the appendix&lt;/a&gt;.&lt;/p&gt;.</param>
        /// <param name="unitTypeList">A list of unit and room type codes indicating which kinds of unit/room type is desired.&lt;p&gt;See also &lt;a href&#x3D;\&quot;#unitand-room-type-codes\&quot;&gt;in the appendix&lt;/a&gt;.&lt;/p&gt;.</param>
        /// <param name="unitAmenityList">A list of room amenity type codes indicating which room level amenities are desired. The codes are AND chained.&lt;p&gt;See also &lt;a href&#x3D;\&quot;#unitand-room-amenity-type-codes\&quot;&gt;in the appendix&lt;/a&gt;.&lt;/p&gt;.</param>
        /// <param name="mealPlanList">A list of meal plan type codes indicating which kinds of meal plan type is desired.&lt;p&gt;See also &lt;a href&#x3D;\&quot;#mealplan-type-codes\&quot;&gt;in the appendix&lt;/a&gt;.&lt;/p&gt;.</param>
        public AvailabilitySearchPostRequest(int adultCount = 2, int childCount = default(int), List<int> childAgeList = default(List<int>), CurrencyCodeEnum currencyCode = default(CurrencyCodeEnum), LanguageCodeEnum languageCode = default(LanguageCodeEnum), UnitSystemEnum? unitSystem = UnitSystemEnum.Metric, int minLengthOfStay = default(int), int maxLengthOfStay = default(int), string locationName = default(string), LocationTypeEnum? locationType = default(LocationTypeEnum?), string earliestArrival = default(string), string latestReturn = default(string), SortEnum? sort = default(SortEnum?), List<ServiceListEnum> serviceList = default(List<ServiceListEnum>), List<TypeListEnum> typeList = default(List<TypeListEnum>), List<UnitTypeListEnum> unitTypeList = default(List<UnitTypeListEnum>), List<UnitAmenityListEnum> unitAmenityList = default(List<UnitAmenityListEnum>), List<MealPlanListEnum> mealPlanList = default(List<MealPlanListEnum>))
        {
        ...
        /// </summary>
        /// <value>The amount of adults that will stay at the property.</value>
        ...
        /// </summary>
        /// <value>The amount of children that will stay at the property.</value>
        ...
        /// </summary>
        /// <value>A list describing the ages of the children that will stay at the property. If &lt;code&gt;childAgeList&lt;/code&gt; is set &lt;code&gt;childCount&lt;/code&gt; has to be set as well. If &lt;code&gt;childAgeList&lt;/code&gt; and &lt;code&gt;childCount&lt;/code&gt; are set, &lt;code&gt;childCount&lt;/code&gt; must be equal to the length of &lt;code&gt;childAgeList&lt;/code&gt;.</value>
        [DataMember(Name="childAgeList", EmitDefaultValue=false)]
        public List<int> ChildAgeList { get; set; }
        ...
        /// </summary>
        /// <value>The desired minimum length of stay in nights.</value>
        ...
        /// </summary>
        /// <value>The desired maximum length of stay in nights.</value>
        ...
        /// </summary>
        /// <value>The name of a location the properties should be located in.If &lt;code&gt;locationType&lt;/code&gt; is set, &lt;code&gt;locationName&lt;/code&gt; has to bet set as well.</value>
        ...
        /// </summary>
        /// <value>The earliest possible arrival date. Expects exactly the format of \&quot;YYYY-MM-DD\&quot;.</value>
        ...
        /// </summary>
        /// <value>The latest possible departure date. Expects exactly the format of \&quot;YYYY-MM-DD\&quot;.</value>
        ...
        /// </summary>
        /// <value>A list of service codes indicating which services and amenities the entire property should offer. The codes are AND chained.&lt;p&gt;See also &lt;a href&#x3D;\&quot;#servicecodes\&quot;&gt;in the appendix&lt;/a&gt;.&lt;/p&gt;</value>
        [DataMember(Name="serviceList", EmitDefaultValue=false)]
        public List<AvailabilitySearchPostRequest.ServiceListEnum> ServiceList { get; set; }
        ...
        /// </summary>
        /// <value>A list of property class type codes specifying the desired property classes. The codes are OR chained.&lt;p&gt;See also &lt;a href&#x3D;\&quot;#propertyclass-type-codes\&quot;&gt;in the appendix&lt;/a&gt;.&lt;/p&gt;</value>
        [DataMember(Name="typeList", EmitDefaultValue=false)]
        public List<AvailabilitySearchPostRequest.TypeListEnum> TypeList { get; set; }
        ...
        /// </summary>
        /// <value>A list of unit and room type codes indicating which kinds of unit/room type is desired.&lt;p&gt;See also &lt;a href&#x3D;\&quot;#unitand-room-type-codes\&quot;&gt;in the appendix&lt;/a&gt;.&lt;/p&gt;</value>
        [DataMember(Name="unitTypeList", EmitDefaultValue=false)]
        public List<AvailabilitySearchPostRequest.UnitTypeListEnum> UnitTypeList { get; set; }
        ...
        /// </summary>
        /// <value>A list of room amenity type codes indicating which room level amenities are desired. The codes are AND chained.&lt;p&gt;See also &lt;a href&#x3D;\&quot;#unitand-room-amenity-type-codes\&quot;&gt;in the appendix&lt;/a&gt;.&lt;/p&gt;</value>
        [DataMember(Name="unitAmenityList", EmitDefaultValue=false)]
        public List<AvailabilitySearchPostRequest.UnitAmenityListEnum> UnitAmenityList { get; set; }
        ...
        /// </summary>
        /// <value>A list of meal plan type codes indicating which kinds of meal plan type is desired.&lt;p&gt;See also &lt;a href&#x3D;\&quot;#mealplan-type-codes\&quot;&gt;in the appendix&lt;/a&gt;.&lt;/p&gt;</value>
        [DataMember(Name="mealPlanList", EmitDefaultValue=false)]
        public List<AvailabilitySearchPostRequest.MealPlanListEnum> MealPlanList { get; set; }
        ...
        /// </summary>
        /// <param name="input">Instance of AvailabilitySearchPostRequest to be compared</param>
        /// <returns>Boolean</returns>
