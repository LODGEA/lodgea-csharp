...
namespace lodgea-csharp.com.lodgea.model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1AvailabilitySearchPost200ResponseListInnerGeo :  IEquatable<V1AvailabilitySearchPost200ResponseListInnerGeo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1AvailabilitySearchPost200ResponseListInnerGeo" /> class.
        /// </summary>
        ...
        public V1AvailabilitySearchPost200ResponseListInnerGeo(string country = default(string), string formattedAddress = default(string), string locality = default(string), string sublocality = default(string), string language = default(string), string establishment = default(string), string countryCode = default(string), string sublocalityLevel1 = default(string), string route = default(string), string administrativeAreaLevel3 = default(string), string administrativeAreaLevel1 = default(string), string streetNumber = default(string), V1AvailabilitySearchPost200ResponseListInnerGeoLocation location = default(V1AvailabilitySearchPost200ResponseListInnerGeoLocation), string stateCode = default(string), string postalCode = default(string), string naturalFeature = default(string), string placeId = default(string))
        {
        ...
        public V1AvailabilitySearchPost200ResponseListInnerGeoLocation Location { get; set; }
        ...
        {
            return this.Equals(input as V1AvailabilitySearchPost200ResponseListInnerGeo);
        }

        /// <summary>
        /// Returns true if V1AvailabilitySearchPost200ResponseListInnerGeo instances are equal
        /// </summary>
        /// <param name="input">Instance of V1AvailabilitySearchPost200ResponseListInnerGeo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1AvailabilitySearchPost200ResponseListInnerGeo input)
        {
            if (input == null)
                return false;
