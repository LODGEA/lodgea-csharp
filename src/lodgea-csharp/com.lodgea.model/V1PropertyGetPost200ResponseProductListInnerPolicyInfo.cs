...
namespace lodgea-csharp.com.lodgea.model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1PropertyGetPost200ResponseProductListInnerPolicyInfo :  IEquatable<V1PropertyGetPost200ResponseProductListInnerPolicyInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1PropertyGetPost200ResponseProductListInnerPolicyInfo" /> class.
        /// </summary>
        ...
        public V1PropertyGetPost200ResponseProductListInnerPolicyInfo(decimal checkInTime = default(decimal), decimal checkOutTime = default(decimal), decimal totalGuestCount = default(decimal), List<V1PropertyGetPost200ResponseProductListInnerPolicyInfoCancellationPolicyListInner> cancellationPolicyList = default(List<V1PropertyGetPost200ResponseProductListInnerPolicyInfoCancellationPolicyListInner>), decimal advanceBookingMin = default(decimal), decimal advanceBookingMax = default(decimal), V1PropertyGetPost200ResponsePropertyPolicyListInnerPetsPolicy petsPolicy = default(V1PropertyGetPost200ResponsePropertyPolicyListInnerPetsPolicy), string prepaymentPolicy = default(string), string guaranteePolicy = default(string), List<V1PropertyGetPost200ResponsePropertyPolicyListInnerTaxPolicyListInner> taxPolicyList = default(List<V1PropertyGetPost200ResponsePropertyPolicyListInnerTaxPolicyListInner>), List<string> feePolicyList = default(List<string>), string name = default(string))
        {
        ...
        public List<V1PropertyGetPost200ResponseProductListInnerPolicyInfoCancellationPolicyListInner> CancellationPolicyList { get; set; }
        ...
        {
            return this.Equals(input as V1PropertyGetPost200ResponseProductListInnerPolicyInfo);
        }

        /// <summary>
        /// Returns true if V1PropertyGetPost200ResponseProductListInnerPolicyInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of V1PropertyGetPost200ResponseProductListInnerPolicyInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1PropertyGetPost200ResponseProductListInnerPolicyInfo input)
        {
            if (input == null)
                return false;
