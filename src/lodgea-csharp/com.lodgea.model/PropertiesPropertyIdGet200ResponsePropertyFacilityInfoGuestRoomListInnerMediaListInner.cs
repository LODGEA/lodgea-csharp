...
namespace lodgea-csharp.com.lodgea.model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner :  IEquatable<PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner>, IValidatableObject
    {
        /// <summary>
        /// Defines TagList
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner" /> class.
        /// </summary>
        ...
        /// <param name="moderationLabelList">A list of detection labels for moderated content (e.g. containing alcoholic beverages) for the media from an AI based detection engine. (required).</param>
        /// <param name="detectionLabelList">A list of detection labels for the media from an AI based detection engine..</param>
        /// <param name="propertyAmenityList">A list of property amenities available at the property that are visible in this media element. (required).</param>
        /// <param name="roomAmenityList">A list of unit and room amenities available at the property (respectively unit type if applicable) that are visible in this media element..</param>
        public PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner(bool isMainImage = default(bool), string url = default(string), decimal sortOrder = default(decimal), List<TagListEnum> tagList = default(List<TagListEnum>), List<string> moderationLabelList = default(List<string>), List<string> detectionLabelList = default(List<string>), List<PropertyAmenityListEnum> propertyAmenityList = default(List<PropertyAmenityListEnum>), List<RoomAmenityListEnum> roomAmenityList = default(List<RoomAmenityListEnum>))
        {
            // to ensure "isMainImage" is required (not null)
            if (isMainImage == null)
            {
                throw new InvalidDataException("isMainImage is a required property for PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner and cannot be null");
            }
            else
            {
            ...
            if (url == null)
            {
                throw new InvalidDataException("url is a required property for PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner and cannot be null");
            }
            else
            {
                this.Url = url;
            ...
            if (sortOrder == null)
            {
                throw new InvalidDataException("sortOrder is a required property for PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner and cannot be null");
            }
            else
            {
            ...
            if (tagList == null)
            {
                throw new InvalidDataException("tagList is a required property for PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner and cannot be null");
            }
            else
            {
            ...
            // to ensure "moderationLabelList" is required (not null)
            if (moderationLabelList == null)
            {
                throw new InvalidDataException("moderationLabelList is a required property for PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner and cannot be null");
            }
            else
            {
            ...
            // to ensure "propertyAmenityList" is required (not null)
            if (propertyAmenityList == null)
            {
                throw new InvalidDataException("propertyAmenityList is a required property for PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner and cannot be null");
            }
            else
            {
        ...
        public List<PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner.TagListEnum> TagList { get; set; }
        ...
        /// </summary>
        /// <value>A list of detection labels for moderated content (e.g. containing alcoholic beverages) for the media from an AI based detection engine.</value>
        [DataMember(Name="moderationLabelList", EmitDefaultValue=true)]
        public List<string> ModerationLabelList { get; set; }

        /// <summary>
        /// A list of detection labels for the media from an AI based detection engine.
        /// </summary>
        /// <value>A list of detection labels for the media from an AI based detection engine.</value>
        ...
        /// </summary>
        /// <value>A list of property amenities available at the property that are visible in this media element.</value>
        [DataMember(Name="propertyAmenityList", EmitDefaultValue=true)]
        public List<PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner.PropertyAmenityListEnum> PropertyAmenityList { get; set; }
        ...
        /// </summary>
        /// <value>A list of unit and room amenities available at the property (respectively unit type if applicable) that are visible in this media element.</value>
        [DataMember(Name="roomAmenityList", EmitDefaultValue=false)]
        public List<PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner.RoomAmenityListEnum> RoomAmenityList { get; set; }
        ...
        {
            return this.Equals(input as PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner);
        }

        /// <summary>
        /// Returns true if PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesPropertyIdGet200ResponsePropertyFacilityInfoGuestRoomListInnerMediaListInner input)
        {
            if (input == null)
                return false;
