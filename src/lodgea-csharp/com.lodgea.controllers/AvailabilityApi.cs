...
namespace lodgea-csharp.com.lodgea.controllers
{
    ...
    public interface IAvailabilityApi : IApiAccessor
    {
        ...
        /// <param name="availabilityGet">Availability get parameter</param>
        /// <returns>V1AvailabilityGetPost200Response</returns>
        ...
        /// <exception cref="lodgea-csharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="availabilityGet">Availability get parameter</param>
        /// <returns>ApiResponse of V1AvailabilityGetPost200Response</returns>
        ApiResponse<V1AvailabilityGetPost200Response> V1AvailabilityGetPostWithHttpInfo (AvailabilityGet availabilityGet);
        /// <summary>
        ...
        /// <returns>Task of V1AvailabilityGetPost200Response</returns>
        System.Threading.Tasks.Task<V1AvailabilityGetPost200Response> V1AvailabilityGetPostAsync (AvailabilityGet availabilityGet, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="availabilityGet">Availability get parameter</param>
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (V1AvailabilityGetPost200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<V1AvailabilityGetPost200Response>> V1AvailabilityGetPostWithHttpInfoAsync (AvailabilityGet availabilityGet, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Search for Availability
        /// </summary>
        /// <remarks>
    ...
    public partial class AvailabilityApi : IAvailabilityApi
    {
        ...
        /// <summary>
        /// Get Availability for Property Get availability information based on a specific property.
        /// </summary>
        /// <exception cref="lodgea-csharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="availabilityGet">Availability get parameter</param>
        /// <returns>V1AvailabilityGetPost200Response</returns>
        public V1AvailabilityGetPost200Response V1AvailabilityGetPost (AvailabilityGet availabilityGet)
        {
             ApiResponse<V1AvailabilityGetPost200Response> localVarResponse = V1AvailabilityGetPostWithHttpInfo(availabilityGet);
        ...
        /// <param name="availabilityGet">Availability get parameter</param>
        /// <returns>ApiResponse of V1AvailabilityGetPost200Response</returns>
        public ApiResponse<V1AvailabilityGetPost200Response> V1AvailabilityGetPostWithHttpInfo (AvailabilityGet availabilityGet)
        {
            // verify the required parameter 'availabilityGet' is set
            if (availabilityGet == null)
                throw new ApiException(400, "Missing required parameter 'availabilityGet' when calling AvailabilityApi->V1AvailabilityGetPost");

            var localVarPath = "/v1/availability/get";
            ...
            if (availabilityGet != null && availabilityGet.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(availabilityGet); // http body (model) parameter
            }
            else
            {
                localVarPostBody = availabilityGet; // byte array
            }
            ...
            {
                Exception exception = ExceptionFactory("V1AvailabilityGetPost", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<V1AvailabilityGetPost200Response>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (V1AvailabilityGetPost200Response) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(V1AvailabilityGetPost200Response)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of V1AvailabilityGetPost200Response</returns>
        public async System.Threading.Tasks.Task<V1AvailabilityGetPost200Response> V1AvailabilityGetPostAsync (AvailabilityGet availabilityGet, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<V1AvailabilityGetPost200Response> localVarResponse = await V1AvailabilityGetPostWithHttpInfoAsync(availabilityGet, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (V1AvailabilityGetPost200Response)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<V1AvailabilityGetPost200Response>> V1AvailabilityGetPostWithHttpInfoAsync (AvailabilityGet availabilityGet, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'availabilityGet' is set
            if (availabilityGet == null)
                throw new ApiException(400, "Missing required parameter 'availabilityGet' when calling AvailabilityApi->V1AvailabilityGetPost");
