...
namespace lodgea-csharp.Client
{
    /// <summary>
    ...
    public partial class ApiClient
    {
        ...
        {
            Configuration = config ?? lodgea-csharp.Client.Configuration.Default;
