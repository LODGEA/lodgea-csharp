...
${nuget_cmd} install src/lodgea-csharp/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/lodgea-csharp.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/lodgea-csharp.dll \
-recurse:'src/lodgea-csharp/*.cs' \
-doc:bin/lodgea-csharp.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/lodgea-csharp.dll was created successfully"
fi
